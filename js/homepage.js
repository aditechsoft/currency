...
$(document).ready(function() {
    ...
    $('.TestimonialSlider').owlCarousel2({
        loop: true,
        margin: 0,
        nav: false,
        items: 1,
